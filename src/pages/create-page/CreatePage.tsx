            ...
            <Form className={styles.form}>
              <div>
                ...
                <Field
                  ...
                  name="name"
                  id="name"
                  className={errors.name && touched.name ? `${styles.input} ${styles.errorInput}` : styles.input}
                />
                <ErrorMessage
                  name="name"
                  component="span"
              ...
              <div>
                ...
                <Field
                  ...
                  name="films"
                  id="films"
                  className={errors.films && touched.films ? `${styles.input} ${styles.errorInput}` : styles.input}
                />
                <ErrorMessage
                  name="films"
                  component="span"
              ...
              <div>
                ...
                <Field
                  ...
                  className={errors.imageUrl && touched.imageUrl ? `${styles.input} ${styles.errorInput}` : styles.input}
                />
                <ErrorMessage
                  name="imageUrl"
                  component="span"
